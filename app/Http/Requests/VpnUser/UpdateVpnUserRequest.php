...
class UpdateVpnUserRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $vpnUserId = $this->route('vpn_user')?->id ?? $this->route('vpn_user');
        ...
        return [
            'username' => [
                ...
                'max:64',
                'alpha_dash:ascii',
                Rule::unique('vpn_users', 'username')->where('tenant_id', $tenantId)->ignore($vpnUserId),
            ],
