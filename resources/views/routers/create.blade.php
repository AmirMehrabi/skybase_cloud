    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input type="password" x-model="form.api_password" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2.5 px-3 border">
            </div>
        </div>
    </div>
...
@scripts
<script src="{{ asset('js/routers/create.js') }}"></script>
@endscripts
@endsection
