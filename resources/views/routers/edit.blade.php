...
@section('content')
<div class="space-y-6 pb-24" x-data="routerEdit(@json($router))" x-cloak>
    <!-- Header -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <select
                    ...
                    class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2.5 px-3 bg-white"
                >
