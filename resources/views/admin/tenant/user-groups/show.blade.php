...
<div class="grid gap-4 md:grid-cols-6">
    @foreach(['Users' => $userGroup->users_count, 'Organizations' => $userGroup->organizations_count, 'Customers' => $userGroup->customers_count, 'Subscriptions' => $userGroup->subscriptions_count, 'Plans' => $userGroup->plans_count, 'Sites' => $userGroup->sites_count] as $label => $count)
