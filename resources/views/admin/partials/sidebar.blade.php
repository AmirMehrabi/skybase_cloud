...
<ul class="space-y-1">
    ...
    <li>
        <a href="{{ url('/admin/dashboard') }}"
           class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ $currentRoute === 'admin.dashboard' ? 'bg-blue-700 text-white' : 'text-blue-50 hover:bg-blue-700 hover:text-white' }} }}">
    ...
    <!-- System Section -->
    <li class="pt-4">
        <div class="px-3 py-2 text-xs font-semibold text-blue-200 uppercase tracking-wider">System</div>
    </li>
