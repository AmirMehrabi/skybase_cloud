...
<div class="space-y-6 pb-24">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Updating {{ $accessPoint->name }}</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('access-points.update', $accessPoint) }}">
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <x-ui.input.select
                    ...
                    :value="old('vendor', $accessPoint->vendor)"
                ...
                <x-ui.input.text
                    ...
                    :value="old('model', $accessPoint->model)"
                ...
                <x-ui.input.text
                    ...
                    :value="old('serial_number', $accessPoint->serial_number)"
                ...
                <x-ui.input.text
                    ...
                    :value="old('firmware_version', $accessPoint->firmware_version)"
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <x-ui.input.text
                    ...
                    :value="old('ip_address', $accessPoint->ip_address)"
                ...
                <x-ui.input.text
                    ...
                    :value="old('ssid', $accessPoint->ssid)"
                ...
                <x-ui.input.select
                    ...
                    :value="old('frequency_band', $accessPoint->frequency_band)"
                ...
                <x-ui.input.text
                    ...
                    :value="old('channel', $accessPoint->channel)"
                ...
                <x-ui.input.text
                    ...
                    name="tx_power"
                    placeholder="e.g., 20"
                    :value="old('tx_power', $accessPoint->tx_power)"
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <x-ui.input.select
                    ...
                    :value="old('site_id', $accessPoint->site_id)"
                ...
                <x-ui.input.select
                    ...
                    :value="old('router_id', $accessPoint->router_id)"
                ...
                <x-ui.input.select
                    ...
                    :value="old('antenna_type', $accessPoint->antenna_type)"
                ...
                <x-ui.input.text
                    ...
                    name="antenna_gain"
                    placeholder="e.g., 14"
                    :value="old('antenna_gain', $accessPoint->antenna_gain)"
                ...
                <x-ui.input.text
                    ...
                    step="0.01"
                    :value="old('height_meters', $accessPoint->height_meters)"
                ...
                <x-ui.input.text
                    ...
                    min="0"
                    max="360"
                    :value="old('azimuth', $accessPoint->azimuth)"
                ...
                <x-ui.input.text
                    ...
                    min="0"
                    max="360"
                    :value="old('coverage_angle', $accessPoint->coverage_angle)"
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <x-ui.input.text
                    ...
                    label="Max Clients"
                    name="max_clients"
                    :value="old('max_clients', $accessPoint->max_clients)"
                ...
                <x-ui.input.text
                    ...
                    :value="old('connected_clients', $accessPoint->connected_clients)"
                ...
                <x-ui.input.select
                    ...
                    :value="old('status', $accessPoint->status)"
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    <x-ui.input.textarea
                        ...
                        :value="old('notes', $accessPoint->notes)"
        ...
        <div class="fixed bottom-0 right-0 left-0 lg:left-64 bg-white border-t border-gray-200 shadow-lg p-4 z-40">
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('access-points.show', $accessPoint) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50">
                    Cancel
                </a>
