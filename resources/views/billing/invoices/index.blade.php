...
<div class="space-y-6" x-data="invoicesIndex()" x-cloak>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <form method="POST" action="{{ route('billing.invoices.generate-recurring') }}">
                @csrf
                <button type="submit" class="inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-1">
                                    <x-ui.action-icon x-bind:href="'/billing/invoices/' + invoice.id" icon="view" label="View" />
                                    <x-ui.action-icon x-bind:href="'/billing/invoices/' + invoice.id + '/edit'" icon="edit" label="Edit" />
                                    <x-ui.action-icon as="button" icon="payment" label="Record Payment" @click="openPaymentModal(invoice)" />
                                    <x-ui.action-icon href="#" icon="download" label="Download PDF" />
