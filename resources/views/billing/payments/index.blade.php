                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-1">
                                    <x-ui.action-icon x-bind:href="'/billing/payments/' + payment.id" icon="view" label="View" />
                                    <x-ui.action-icon x-bind:href="'/billing/invoices/' + payment.invoice_id" icon="invoice" label="View Invoice" />
                                </div>
                            </td>
                        </tr>
                    </template>
