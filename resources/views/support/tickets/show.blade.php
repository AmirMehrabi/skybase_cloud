        ...
        <div class="rounded-xl border border-slate-900/10 bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('work-orders.create', ['customer_id' => $ticket->customer_id, 'ticket_id' => $ticket->id]) }}" class="rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50">Create work order</a>
