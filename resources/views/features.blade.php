...
@section('content')
<!-- Hero Section -->
    <section class="relative isolate overflow-hidden bg-[#0d2f35] py-20 text-white sm:py-24">
        <div class="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_15%_20%,rgba(34,197,94,0.28),transparent_28%),radial-gradient(circle_at_85%_15%,rgba(245,197,66,0.22),transparent_30%),linear-gradient(135deg,#09252b_0%,#0d2f35_46%,#123f3d_100%)]"></div>
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                <h1 class="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6">
                    Everything You Need to Run Your ISP
                </h1>
                <p class="text-xl text-teal-50/85 mb-8 leading-relaxed">
    ...
    <section class="py-16 bg-white">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-slate-950 mb-6">A Complete ISP Management Platform</h2>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Subscriber Management</h3>
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Complete customer profiles</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service and plan management</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Account status automation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Subscriber activity history</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Search and filtering tools</span>
                            </li>
                        </ul>
                    </div>
                    <div class="bg-white border border-slate-950/10 rounded-2xl shadow-sm p-5 sm:p-6">
                        <div class="rounded-[1.5rem] border border-slate-200 bg-[#fbf7ed] p-4 sm:p-5">
                            <div class="flex flex-col gap-4">
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-teal-700">Customers</p>
                                        <h4 class="mt-1 text-lg font-semibold text-slate-900">Subscriber workspace</h4>
                                    </div>
                                    <div class="inline-flex items-center gap-2 rounded-2xl bg-[#0d2f35] px-3 py-2 text-xs font-semibold text-white">
                                ...
                                <div class="rounded-2xl border border-slate-200 bg-white p-3">
                                    <div class="grid gap-3 sm:grid-cols-[minmax(0,1.5fr)_repeat(3,minmax(0,1fr))]">
                                        <div class="rounded-2xl border border-slate-200 bg-[#fbf7ed] px-3 py-2 text-sm text-slate-500">Search by name, email, phone...</div>
                                        <div class="rounded-2xl border border-slate-200 bg-[#fbf7ed] px-3 py-2 text-sm text-slate-500">Status</div>
                                        <div class="rounded-2xl border border-slate-200 bg-[#fbf7ed] px-3 py-2 text-sm text-slate-500">Plan</div>
                                        <div class="rounded-2xl border border-slate-200 bg-[#fbf7ed] px-3 py-2 text-sm text-slate-500">Router</div>
                                    </div>
                                </div>

                                <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                                    <div class="grid grid-cols-[minmax(0,1.2fr)_0.9fr_0.9fr] border-b border-slate-200 bg-[#fbf7ed] px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                                        <span>Customer</span>
                                        <span>Plan</span>
                                        <span>Status</span>
                                    </div>
    ...
    <section class="py-16 bg-white">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div class="order-2 md:order-1 bg-white border border-slate-950/10 rounded-2xl shadow-sm p-5 sm:p-6">
                        <div class="rounded-[1.5rem] border border-emerald-100 bg-gradient-to-br from-[#fbf7ed] to-white p-4 sm:p-5">
                            <div class="flex flex-col gap-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <div class="rounded-2xl bg-white px-3 py-2 text-xs font-semibold text-slate-700 ring-1 ring-inset ring-slate-200">This Month</div>
                                </div>
                                ...
                                <div class="grid gap-3 lg:grid-cols-[minmax(0,1.2fr)_0.8fr]">
                                    ...
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-2"><span class="text-sm text-slate-600">Paid</span><span class="font-semibold text-emerald-600">214</span></div>
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-2"><span class="text-sm text-slate-600">Pending</span><span class="font-semibold text-amber-600">38</span></div>
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-2"><span class="text-sm text-slate-600">Overdue</span><span class="font-semibold text-rose-600">9</span></div>
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-2"><span class="text-sm text-slate-600">Autopay success</span><span class="font-semibold text-slate-900">91%</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="order-1 md:order-2">
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Automated Billing</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Automated invoice generation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Flexible billing cycles</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Payment tracking</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service suspension automation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Usage-based billing support</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">MikroTik Integration</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-slate-700">PPPoE authentication</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Hotspot authentication</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">RADIUS integration</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Automated service activation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-emerald-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Device synchronization</span>
                            </li>
                        </ul>
                    </div>
                    <div class="bg-white border border-slate-950/10 rounded-2xl shadow-sm p-5 sm:p-6">
                        <div class="rounded-[1.5rem] border border-violet-100 bg-gradient-to-br from-violet-50 to-white p-4 sm:p-5">
                            <div class="space-y-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <span class="rounded-2xl bg-slate-900 px-3 py-2 text-xs font-semibold text-white">18 connected</span>
                                </div>
                                ...
                                <div class="grid gap-3 lg:grid-cols-[minmax(0,1.1fr)_0.9fr]">
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-3">
                                                <div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="rounded-[1.5rem] border border-orange-100 bg-gradient-to-br from-orange-50 to-white p-4 sm:p-5">
                            <div class="space-y-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <span class="rounded-2xl bg-white px-3 py-2 text-xs font-semibold text-slate-700 ring-1 ring-inset ring-slate-200">14 pending installs</span>
                                </div>
                                ...
                                <div class="grid gap-3 lg:grid-cols-[0.95fr_minmax(0,1.05fr)]">
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div class="mt-4 flex flex-col gap-3">
                                            <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3 text-sm text-slate-700">1. Assign plan and bandwidth profile</div>
                                            <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3 text-sm text-slate-700">2. Push PPPoE credentials to router</div>
                                            <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3 text-sm text-slate-700">3. Reserve IP from matching pool</div>
                                            <div class="rounded-2xl bg-slate-900 px-3 py-3 text-sm font-semibold text-white">4. Activate service and notify customer</div>
                                        </div>
                                    </div>
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        <p class="text-sm font-semibold text-slate-900">Recent jobs</p>
                                        <div class="mt-4 space-y-3">
                                            <div class="flex items-start justify-between rounded-2xl bg-[#fbf7ed] px-3 py-3">
                                                <div>
                    ...
                    <div class="order-1 md:order-2">
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Network Provisioning</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-slate-700">Network device provisioning</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-orange-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Subscriber bandwidth control</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-orange-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service plan assignment</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-orange-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Device automation workflows</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Customer Self-Service Portal</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-slate-700">Invoice and payment access</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service status monitoring</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Support ticket creation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Account profile management</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-cyan-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Usage visibility</span>
                            </li>
                        </ul>
                    </div>
                    <div class="bg-white border border-slate-950/10 rounded-2xl shadow-sm p-5 sm:p-6">
                                ...
                                <div class="space-y-4 p-4">
                                    ...
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div class="mt-3 grid grid-cols-2 gap-3">
                                            ...
                                            <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3 text-center text-sm font-medium text-slate-700">Open Ticket</div>
                                            <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3 text-center text-sm font-medium text-slate-700">View Usage</div>
                                            <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3 text-center text-sm font-medium text-slate-700">Update Profile</div>
                                        </div>
                                    </div>
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        <p class="text-sm font-semibold text-slate-900">Latest invoice</p>
                                        <div class="mt-3 flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-3">
                                            <div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="rounded-[1.5rem] border border-rose-100 bg-gradient-to-br from-rose-50 to-white p-4 sm:p-5">
                            <div class="space-y-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <span class="rounded-2xl bg-white px-3 py-2 text-xs font-semibold text-slate-700 ring-1 ring-inset ring-slate-200">9 open tickets</span>
                                </div>
                                ...
                                <div class="grid gap-3 lg:grid-cols-[0.95fr_minmax(0,1.05fr)]">
                                    <div class="space-y-3">
                                        <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                            ...
                                            <div class="mt-4 space-y-3">
                                                <div class="rounded-2xl bg-[#fbf7ed] px-3 py-3">
                                    ...
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <div class="max-w-[85%] rounded-2xl rounded-tl-md bg-[#f6f1e8] px-4 py-3 text-sm text-slate-700">
                                        ...
                                        <div class="mt-4 rounded-2xl border border-slate-200 bg-[#fbf7ed] px-3 py-3 text-sm text-slate-500">Write a reply...</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="order-1 md:order-2">
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Support Ticketing System</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-rose-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Ticket creation and tracking</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-rose-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Staff assignment</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-rose-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Customer communication threads</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-rose-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Status updates</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-rose-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service issue tracking</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Automation & Workflows</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-slate-700">Billing-triggered automation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service activation workflows</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Account suspension rules</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Scheduled operations</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Event-based triggers</span>
                            </li>
                        </ul>
                    </div>
                    <div class="bg-white border border-slate-950/10 rounded-2xl shadow-sm p-5 sm:p-6">
                        <div class="rounded-[1.5rem] border border-emerald-100 bg-gradient-to-br from-[#fbf7ed] to-white p-4 sm:p-5">
                            <div class="space-y-4">
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-teal-700">Workflow Engine</p>
                                        <h4 class="mt-1 text-lg font-semibold text-slate-900">Rules, triggers, and run history</h4>
                                    </div>
                                    <span class="rounded-2xl bg-slate-900 px-3 py-2 text-xs font-semibold text-white">27 active rules</span>
                                </div>

                                <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                    <div class="grid gap-3 sm:grid-cols-[0.9fr_0.2fr_0.9fr_0.2fr_0.9fr] sm:items-center">
                                        <div class="rounded-2xl bg-[#fbf7ed] p-4">
                                        ...
                                        <div class="hidden text-center text-slate-300 sm:block">→</div>
                                        <div class="rounded-2xl bg-[#0d2f35] p-4 text-white">
                                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-100">Outcome</p>
    ...
    <section class="py-16 bg-white">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div class="order-2 md:order-1 bg-white border border-slate-950/10 rounded-2xl shadow-sm p-5 sm:p-6">
                        <div class="rounded-[1.5rem] border border-teal-100 bg-gradient-to-br from-[#fbf7ed] to-white p-4 sm:p-5">
                            <div class="space-y-4">
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                    ...
                                    <span class="rounded-2xl bg-white px-3 py-2 text-xs font-semibold text-slate-700 ring-1 ring-inset ring-slate-200">Export CSV</span>
                                </div>
                                ...
                                <div class="grid gap-3 lg:grid-cols-[minmax(0,1.1fr)_0.9fr]">
                                    ...
                                    <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-3"><span class="text-sm text-slate-600">Tower East</span><span class="font-semibold text-slate-900">18.2 TB</span></div>
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-3"><span class="text-sm text-slate-600">POP North</span><span class="font-semibold text-slate-900">14.7 TB</span></div>
                                            <div class="flex items-center justify-between rounded-2xl bg-[#fbf7ed] px-3 py-3"><span class="text-sm text-slate-600">Fiber Core</span><span class="font-semibold text-slate-900">22.9 TB</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="order-1 md:order-2">
                        ...
                        <h3 class="text-3xl font-bold text-slate-950 mb-4">Reports & Analytics</h3>
                        <p class="text-lg text-slate-600 mb-6">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-slate-700">Revenue reporting</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Subscriber growth metrics</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Service performance insights</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Operational dashboards</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-teal-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-slate-700">Exportable reports</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- Final CTA Section -->
    <section class="py-20 bg-[#f6f1e8]">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-slate-950 mb-6">Start Running Your ISP More Efficiently</h2>
