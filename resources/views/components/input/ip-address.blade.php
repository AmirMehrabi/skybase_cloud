...
<div class="mb-4">
    ...
    <div class="relative">
        <input
            ...
            @else
                class="px-4 py-3 w-full bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 font-mono focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition"
            @enderror
        >
    </div>
