...
<div class="mb-4">
    ...
    <div class="relative">
        ...
        <input
            ...
            @error($name)
                class="{{ $icon ? 'pl-10 pr-4' : 'px-4' }} w-full rounded-lg border border-red-500 bg-white py-3 text-slate-950 placeholder-slate-500 transition focus:border-transparent focus:outline-none focus:ring-2 focus:ring-emerald-600"
            @else
