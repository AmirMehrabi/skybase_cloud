<form action="{{ route('settings.update.branding') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Customize your application's color scheme</p>
        </div>
        <div class="p-6">
            ...
            <div class="mt-6">
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input type="checkbox" name="dark_mode_enabled" id="dark_mode_enabled" value="1"
                               {{ old('dark_mode_enabled', $tenant->dark_mode_enabled) ? 'checked' : '' }}
                               class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
                        <label for="dark_mode_enabled" class="font-medium text-gray-700">Enable Dark Mode</label>
                        <p class="text-gray-500">Allow users to switch to dark mode theme.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea name="custom_css" id="custom_css" rows="8"
                          class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm font-mono text-sm @error('custom_css') border-red-500 @enderror"
                          placeholder="/* Custom CSS */&#10;.custom-class {&#10;  color: #3b82f6;&#10;}">{{ old('custom_css', $tenant->custom_css) }}</textarea>
                @error('custom_css')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Logo & Assets</h3>
            <p class="mt-1 text-sm text-gray-500">Upload your company logos and images</p>
        </div>
        <div class="p-6">
