...
Laravel uses config-based routing. Public marketing routes map `/`, `/features`, `/pricing`, `/changelog`, `/contact`, and comparison pages through `PagesController`. Authenticated routes use the admin layout and tenant middleware.
